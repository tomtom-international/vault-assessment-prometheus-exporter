...
def test_from_duration_get_seralized_expiration(weeks, days, hours, minutes, seconds):
    ...
    """
    last_renewed_time = datetime.datetime.utcnow()
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            {"expiration_timestamp": "2022-08-08T09:49:41.415869Z", "last_renewed_timestamp": "1970-01-01T00:00:00Z"},
        ),
        ...
        (
            ...
            {"last_renewed_timestamp": "2022-08-08T09:49:41.415869Z", "expiration_timestamp": "1970-01-01T00:00:00Z"},
        ),
        ...
        (
            ...
            {"expiration_timestamp": "1970-01-01T00:00:00Z", "last_renewed_timestamp": "2022-05-02T09:49:41.415869Z"},
        ),
        ...
        (
            {},
            {"expiration_timestamp": "1970-01-01T00:00:00Z", "last_renewed_timestamp": "1970-01-01T00:00:00Z"},
        ),
        # Malformed both
        (
