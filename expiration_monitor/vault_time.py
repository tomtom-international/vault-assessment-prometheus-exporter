...
class expirationMetadata:
    ...
    @classmethod
    def fromDuration(cls, expiration_weeks, expiration_days, expiration_hours, expiration_minutes, expiration_seconds, last_renewed_timestamp_fieldname: str, expiration_timestamp_fieldname: str):
        """
    ...
    @classmethod
    def fromMetadata(cls, metadata: dict, last_renewed_timestamp_fieldname: str, expiration_timestamp_fieldname: str):
