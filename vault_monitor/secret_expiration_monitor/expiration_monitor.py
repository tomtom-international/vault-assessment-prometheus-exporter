...
class ExpirationMonitor:
    ...
    def __init__(self, mount_point: str, secret_path: str, vault_client: hvac.Client, service: str, prometheus_labels: Dict[str, str] = {}, metadata_fieldnames: Dict[str, str] = {}) -> None:
        """
